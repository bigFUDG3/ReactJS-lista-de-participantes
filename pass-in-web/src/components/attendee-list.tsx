    ...
    return (
        <div className='flex flex-col gap-4'>
            <div className="flex gap-3 items-center">
                <h1 className="text-2xl font-bold">Particpantes</h1>
                    ...
                    <thead>
                        <TableRow>
                            <TableHeader style={{ width: 48 }}>
                                <input type="checkbox" className="size-4 bg-black/20 border-white/10 rounded border accent-orange-400"/></TableHeader>
                    ...
                    <tbody>
                        {attendees.map((attendee) => {
                            return (
                                ...
                                <TableCell>
                                    <input type="checkbox" className="size-4 bg-black/20 border-white/10 rounded border accent-orange-400 accent-orange"/>
                                </TableCell>
